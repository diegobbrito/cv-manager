...
func (r *mutationResolver) CreateBasicInfo(ctx context.Context, basicInfo model.BasiInfoInput) (*model.BasicInfo, error) {
...
func (r *mutationResolver) UpdateBasicInfo(ctx context.Context, id string, basicInfo model.BasiInfoInput) (*model.BasicInfo, error) {
